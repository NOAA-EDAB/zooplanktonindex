...
One set of calfin models attempted the split into 4 seasons to have spring (months 3-5) and fall (months 9-11) matching trawl survey months and winter and summer in between. There are large data gaps in winter and summer so these models may not run.
...
filterEPUs <- c("her_sp", "her_fa", "MAB", "GB", "GOM", "SS", "AllEPU")
...
currentMonth <- lubridate::month(Sys.Date())
    ...
    p <- splitoutput |>
      ...
      ggplot2::geom_point()+
      ggplot2::geom_line()+
      ggplot2::ggtitle("Calanus finmarchicus")+
