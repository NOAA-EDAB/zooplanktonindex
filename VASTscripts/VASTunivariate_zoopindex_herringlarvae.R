...
mod.season <- c("herringlarvae_fall_500", "herringlarvae_spring_500") #includes n knots

mod.dat <- list(herringlarvae_stn_fall, herringlarvae_stn_spring)

names(mod.dat) <- mod.season

mod.obsmod <- list(ObsModel1, ObsModel1)
