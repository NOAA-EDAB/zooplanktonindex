...
Model selection looked at inclusion of different spatial and spatio-temporal random effects. Testing alwaus included all of them. See [here](https://noaa-edab.github.io/zooplanktonindex/CopeModSelection.html). 
...
```{r, results = "asis"}
for(d.name in moddirs_conv[str_detect(moddirs_conv, "calfin")]){
...
```{r, results = "asis"}
for(d.name in moddirs_conv[str_detect(moddirs_conv, "lgcopeALL")]){
...
```{r, results = "asis"}
for(d.name in moddirs_conv[str_detect(moddirs_conv, "smallcopeALL")]){
...
```{r, results = "asis"}
for(d.name in moddirs_conv[str_detect(moddirs_conv, "smallcopeSOE")]){
...
```{r, results = "asis"}
for(d.name in moddirs_conv[str_detect(moddirs_conv, "zoopvol")]){
