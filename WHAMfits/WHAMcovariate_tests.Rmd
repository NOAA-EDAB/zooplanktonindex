...
#cant compare to original, not the same data
#test <- compare_wham_models(mods = list("orig" = mm192mod, "testecovoff" = mod), fdir = write.dir)

plot_wham_output(mod = mod, dir.main = file.path(write.dir))
