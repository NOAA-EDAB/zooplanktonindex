...
Run models with different data entry options
...
for(m in 1:n.mods){
  ...
  ecovsig <- if(df.mods$ecovdat[m] %in% c("logmean-logsig", "meanmil-logsigmil1")){
...
Estimated large copepods all Jan-June (Spring) covariate ("ar1", m5):

```{r}
knitr::include_graphics(here::here(write.dir, "m4/plots_png/results/Ecov_1_lgCopeSpring2.png"))
```
